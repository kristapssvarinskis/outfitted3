...
export default function Home() {
  return (
    <main className="flex items-center justify-center bg-neutral-700 min-h-screen">
      <div className="bg-neutral-700 border border-black rounded-lg shadow-lg p-6 w-full max-w-lg">
